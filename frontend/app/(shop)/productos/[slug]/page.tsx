  ...
  return (
    <div className="min-h-screen bg-amanda-white pt-16 pb-20 md:pb-0">
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-amanda-white border-t border-amanda-lightgray px-4 py-3">
        {isOutOfStock ? (
          <div className="w-full py-3.5 text-center text-[10px] tracking-widest uppercase text-amanda-gray border border-amanda-lightgray">
            Sin stock
          </div>
        ) : (
          <button
            onClick={handleAddToCart}
            className={`w-full py-3.5 text-[10px] tracking-widest uppercase transition-all ${
